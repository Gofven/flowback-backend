...
def pre_populate_fields(apps, schema_editor):
    ...
    WorkGroup.objects.bulk_update(work_groups, ['chat'])
...
def pre_populate_fields_two(apps, schema_editor):
    ...
    for work_group_user in WorkGroupUser.objects.all():
        ...
        work_group_users.append(work_group_user)

    WorkGroupUser.objects.bulk_update(work_group_users, ['chat_participant'])
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='chat',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='chat.messagechannel', null=True)
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='chat.messagechannelparticipant', null=True)
        ),
