# Generated by Django 4.0.8 on 2022-11-14 17:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='poll',
            constraint=models.CheckConstraint(check=models.Q(('start_date__gte', datetime.datetime(2022, 11, 14, 17, 16, 42, 617806, tzinfo=utc))), name='nowgreaterthanstartdate_check'),
        ),
        migrations.AddConstraint(
            model_name='poll',
            constraint=models.CheckConstraint(check=models.Q(('proposal_end_date__gte', django.db.models.expressions.F('start_date'))), name='proposalenddategreaterthanstartdate_check'),
        ),
        migrations.AddConstraint(
            model_name='poll',
            constraint=models.CheckConstraint(check=models.Q(('prediction_end_date__gte', django.db.models.expressions.F('proposal_end_date'))), name='predictionenddategreaterthanproposalenddate_check'),
        ),
        migrations.AddConstraint(
            model_name='poll',
            constraint=models.CheckConstraint(check=models.Q(('delegate_vote_end_date__gte', django.db.models.expressions.F('prediction_end_date'))), name='delegatevoteenddategreaterthanpredictionenddate_check'),
        ),
        migrations.AddConstraint(
            model_name='poll',
            constraint=models.CheckConstraint(check=models.Q(('vote_end_date__gte', django.db.models.expressions.F('delegate_vote_end_date'))), name='voteenddategreaterthandelegatevoteenddate_check'),
        ),
        migrations.AddConstraint(
            model_name='poll',
            constraint=models.CheckConstraint(check=models.Q(('end_date__gte', django.db.models.expressions.F('vote_end_date'))), name='enddategreaterthanvoteenddate_check'),
        ),
