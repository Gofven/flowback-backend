...
poll_patterns = [
    ...
    path('<int:prediction_statement_id>/prediction/create', PollPredictionBetCreateAPI.as_view(),
         name='poll_prediction_create'),
    path('<int:prediction_id>/prediction/update', PollPredictionBetUpdateAPI.as_view(),
         name='poll_prediction_update'),
    path('<int:prediction_id>/prediction/delete', PollPredictionBetDeleteAPI.as_view(),
